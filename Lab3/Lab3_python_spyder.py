...
from pandas import DataFrame,Series #los que se usaran 
import os # for usernanme y set directorio

# Debemos construir el directorio donde se trabajará
# 

user = os.getlogin()   # Username, me da el user name
print(user)  #DELL

# Set directorio

os.chdir(f"C:/Users/{user}/Documents/GitHub/1ECO35_2022_2/Lab3") # Setear directorio

netflix = pd.read_csv("../data/netflix_titles.csv") # Subir base de datos, usamos panda para leer csv y por default lee caracteres especiales
netflix

netflix.info() # varaible's type 

print( netflix.shape ) # filas(obs) y columnas(var)
